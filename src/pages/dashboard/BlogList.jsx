...
import deletBlogContent from "../../redux/thunk/deletBlogContent";
                ...
                <tr>
                  ...
                  <td class='p-2'>
                    <div class='flex justify-center'>
                      <button
                        onClick={() => dispatch(deletBlogContent(_id))}
                      >
                        <svg
                      ...
                      <Link
                        ...
                        className="text-lg ml-3  w-10 h-10 text-blue-600">
                        <BiEdit />
                      </Link>
                    </div>
                  </td>
